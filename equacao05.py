...
# O número é 6 porque ao substituir na equação 3x - 5 = 2x + 1 temos:
# 3x - 2x = 1 + 5 → x = 6
# Ao calcular o triplo de 6 menos 5 obtemos 18 - 5 = 13, e o dobro de 6 mais 1 é 12 + 1 = 13.
# Portanto, ambos os lados da equação são iguais, confirmando que a solução está correta